import './style.css';
const PROFILE = {"day":"Day017","title":"Incident Response Wizard","one_sentence":"障害初動フローをステップ分岐で確定する運用ウィザード。（話題:HN Frontpage）","core_action":"triage","family":"incident_wizard","mechanic":"branching_triage","input_style":"step_choices","output_style":"response_flow","audience_promise":"faster_incident_response","publish_hook":"初動手順を分岐で迷わず確定","engine":"wizard_tree","interaction_archetype":"decision_tree_wizard","page_archetype":"stepper_wizard","output_shape":"decision_path","state_model":"step_index_and_answers","core_loop":"classify -> branch -> assign","component_pack":"stepper+severity_badges","scaffold_id":"wizard_stepper","single_shot_text_generator":false};
